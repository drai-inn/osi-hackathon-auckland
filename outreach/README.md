...
| Placeholder | Meaning |
| --- | --- |
| `{{DATES}}` | `Wed 21 – Thu 22 October 2026` *(recommended)* or `Mon 19 – Tue 20 October` |
...
3. **Name the discipline's own question.** Nobody outside computational chemistry wants to attend a
   drug-discovery hackathon. A statistician wants to know when a small experiment predicts a large
   one. Lead with theirs, not ours.
