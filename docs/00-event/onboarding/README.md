...
finish in a sitting, each one leaving you genuinely more useful than the rung below.

**You can stop at any rung.** Rung 1 of every ladder is worth something on its own. That is the
design, not a consolation.

---

## The rungs, in general

Every ladder has the same five, so you always know where you are:

| Rung | Roughly | You end up |
| --- | --- | --- |
| **0 · Orient** | 10 min | Knowing what this is and whether it's for you |
...
| --- | --- | --- | --- |
| **A** | **[New to AI for science](newcomer.md)** | You're curious, you're an expert in something else, and you've never done this | Running one configuration and seeing your name on the dashboard |
| **B** | **[Domain expert](domain-expert.md)** | Chemistry, pharmacology, structural biology. You know molecules, not pipelines | Looking at five predicted poses and saying which are wrong |
| **C** | **[ML and statistics](ml-stats.md)** | You model things. Chemistry is not the draw; the methodology is | Reading the small-data result and telling us where it breaks |
| **D** | **[Builder](builder.md)** | RSE, HPC, infrastructure, or you want to write the pipeline | Getting `make smoke` green on your machine |
...
And check the claim at the top of the ladder against reality before the event. A ladder that
promises thirty minutes and takes two hours is worse than no ladder, because the person concludes
