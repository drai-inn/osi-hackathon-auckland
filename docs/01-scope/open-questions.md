...
| **A7** | **🔴 Which dates — 19–20 Oct, or the official 21–22 Oct?** | The flier and [llmhackathon.github.io](https://llmhackathon.github.io/) both say 21–22 Oct, and **Auckland is already listed as a 2026 hub**. Running early forfeits the global Slack, mentors, prizes, the showcase and **inclusion in the write-up paper**. On the official dates Auckland is the *first hub in the world to start*. The date is on the poster | Nick | **Mon 21 Sep** ([public-presence.md](../04-hackathon/public-presence.md)) | 🔴 |
