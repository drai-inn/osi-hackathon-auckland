...
| Learning mode | delta/residual learning · fine-tuning · calibration-only | Delta learning is the default; calibration-only is the fallback if the scorer is not fine-tunable ([B3](../../01-scope/open-questions.md)) |
