...
Almost every gate in [stage-gates.md](../../05-feasibility/stage-gates.md) is of the form
*"is X worth its cost?"* — and every cost figure in
[compute-budget.md](../../05-feasibility/compute-budget.md) is currently `[estimate]`. WP-F's job
...
- Cluster access or quota discovered to be inadequate on day 1 (→ [A2](../../01-scope/open-questions.md))
...
1. Confirm cluster access, quota, queue policy ([A2](../../01-scope/open-questions.md))
