...
rather than optimiser settings. See [hpo-microtopic.md](../03-experiments/hpo-microtopic.md) for
...
See [success criteria and stage gates](../05-feasibility/stage-gates.md).
