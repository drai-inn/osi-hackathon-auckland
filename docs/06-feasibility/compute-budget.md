...
> [critical-path.md](../05-delivery/critical-path.md).
>
...
- **The S5 random search (72 GPU-h) is the single largest line, at 40% of the subtotal.** That is
  ...
  which is why [the microtopic](../04-experiments/hpo-microtopic.md) concentrates its configuration
...
what [diagnostic D2](../04-experiments/hpo-microtopic.md#q2--does-sensitivity-fall-as-scale-rises-the-headline) tests.
...
1. Reference MD validation → 3 systems instead of 5 (saves ~8 GPU-h, weakens
   [contract 2](../03-pipeline/fidelity-contracts.md))
