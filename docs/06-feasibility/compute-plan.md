...
[W2.7](../05-delivery/critical-path.md#week-2--28-sep--4-oct--skeleton) measures the real ratio by
...
**What to do, in week 1** ([W1.1](../05-delivery/critical-path.md#week-1--2127-sep--unblock)):
...
| Week 3, **1–2 days** | **Quantum convergence study** ([S6](../03-pipeline/stages/S6-quantum-labelling.md#the-convergence-check-comes-first)) | DFT is bandwidth-bound and cuEST may be `x86_64`-only. Also the load-bearing check of the whole project |
...
- Exact GB10 specification and whether the pair presents as one 256 GB device or two ([W1.1](../05-delivery/critical-path.md))
- Whether cuEST has an `aarch64` build at all ([W1.3](../05-delivery/critical-path.md))
- H200 queue policy: reservation or fair-share? Determines whether "book a block" means anything ([W1.2](../05-delivery/critical-path.md))
