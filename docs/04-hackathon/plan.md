...
([compute-plan.md](../05-feasibility/compute-plan.md)).
...
| **Engagement** — the [on-ramps](engagement.md) | The point of holding an event rather than doing the work quietly |
...
| **09:20** | **Sealed forecast** — six binary predictions, sealed until tomorrow ([on-ramp D](engagement.md#d--sealed-forecast--everyone--10-min-day-1-opening)) | all |
| **09:30** | **Explainer pairs** — each package explains itself to a newcomer in 5 minutes, no slides ([on-ramp F](engagement.md#f--explainer-pairs--everyone--5-min-per-package-day-1)) | hosts |
...
| **12:00** | Lunch | |
| **13:00** | **Gate assessment** against [stage-gates.md](../05-feasibility/stage-gates.md). Honest colour on each, intervals shown | all |
...
- **One room, six tables**, hosts distinct from owners ([why](engagement.md#the-structural-fix-split-the-host-role))
...
- **A surprises board.** Anything contradicting an assumption in this repo goes up and gets folded
  back into [open-questions.md](../01-scope/open-questions.md)
