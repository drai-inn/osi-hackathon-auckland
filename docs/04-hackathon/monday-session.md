...
| | | |
| --- | --- | --- |
| **0:00–0:10** | **Framing.** Two days, not five. The month is the project; the event is the experiment. One month, 20 working days | Nick |
| **0:10–0:25** | **The compute picture.** GB10 now through the end; H200 for benchmarks. The `aarch64`/`x86_64` split and why it is the most under-appreciated risk ([compute-plan.md](../05-feasibility/compute-plan.md)) | Nick / WP-F candidate |
...
| Send invitations | Wed 23 Sep | Nick |
