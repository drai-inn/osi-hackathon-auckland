...
| 9 | **Filled fidelity contracts** | stage owners | [Template](../02-pipeline/fidelity-contracts.md#contract-template) |
...
| ☐ | **They have read this repo** — especially [scope](../01-scope/scope.md) and [stage-gates](../05-feasibility/stage-gates.md) | Week 2 |
