...
([A3](../01-scope/open-questions.md), [A5](../01-scope/open-questions.md)) and should be made
...
care about?*
**Detail:** [hpo-microtopic.md](../03-experiments/hpo-microtopic.md)
...
- Why small-scale experiments are *harder* to tune than large ones, and the geometry behind it
  ([Lourie et al.](../00-context/source-notes/small-scale-experiments.md))
...
([the cascade](../02-pipeline/architecture.md#the-surrogate-cascade)). The general problem —
...
**Sessions**
- The fidelity contract as a design pattern ([fidelity-contracts.md](../02-pipeline/fidelity-contracts.md))
