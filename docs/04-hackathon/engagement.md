...
1. **Time to first result under 30 minutes.** Measured, with a real novice, in week 4
   ([W4.2](critical-path.md#week-4--1218-oct--rehearse-and-pre-compute)). If it takes longer, the
...
[methodology](../03-experiments/methodology.md) needs many configurations, and a room of people
each owning one is a better use of the room than a queue script.

**Build (month):** launcher script, allocation scheme, live dashboard ([W3.6](critical-path.md)).
**Owner:** WP-F.
...
[fidelity contract 1](../02-pipeline/fidelity-contracts.md#1-co-folding-s1--replaces-experimental-structure-determination)
...
([W4.4](critical-path.md)). **Owner:** WP-B + host.
...
This directly attacks [R2](../05-feasibility/risks.md), the highest-probability project-threatening
risk in the register.

**Build (month):** baseline computed and presented as a browsable table ([W2.6](critical-path.md)).
**Owner:** WP-A + host.
...
[gates](../05-feasibility/stage-gates.md): *Will motion-awareness improve ranking stability? Will
...
**Build (month):** six questions drafted ([W3.7](critical-path.md)), a form, sealed envelopes or a
locked sheet. **Owner:** Nick.

### E — Bring your own small-data problem · *visiting researchers, statisticians, any empirical field* · 90 min

The [Activity 2 clinic](adjacent-activities.md#activity-2--small-data-hyperparameter-science).
...
| Quantum chemistry / physics | A — your run | [Activity 3](adjacent-activities.md#activity-3--the-fidelity-ladder-quantum-surrogates-and-knowing-when-to-trust-them), embed in WP-E |
...
- **No jargon without a glossary link.** [glossary.md](../01-scope/glossary.md) exists for this and
