...
B3, *is Nesso-1 fine-tunable, or inference-only?*, is a 🔴
...
| **NeSI / NZ eResearch** | national | Not hackathon-connected, but the natural Phase-3 infrastructure partner and an [Activity 4](themes.md) constituency |
...
| When | Who | Ask |
| --- | --- | --- |
| **Mon 21 Sep** | Ben Blaiszik | **Resolve the dates.** Confirm the Auckland hub. Ask for an introduction to Valence Labs re: Nesso-1 (B3) |
...
| During the event | LIAC (EPFL), Mauricio Cafiero, the F.A.D.E team | Live remote sessions in the [adjacent activities](themes.md) |
