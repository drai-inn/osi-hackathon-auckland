...
Only valid when both numbers come from comparable assays (→ C1).
...
open-weight example. Our [S1](worked-example.md).
...
as a curve we extrapolate (why not).
...
in [stage-gates.md](small-experiments.md).
