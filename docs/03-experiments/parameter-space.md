...
| --- | --- | --- | --- | --- |
| Decoy strategy | S0 | `s0.decoys` | property-matched, DUD-E style, literature non-selective | Determines whether enrichment means anything ([S0](../02-pipeline/stages/S0-benchmark.md)) |
| Ensemble aggregation | S5 | `s5.aggregation` | weighted mean, Boltzmann, min | Changes what "the score" means ([S5](../02-pipeline/stages/S5-equivariant-scoring.md)) |
