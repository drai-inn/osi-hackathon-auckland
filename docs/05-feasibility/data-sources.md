...
([E2](../01-scope/open-questions.md)), every source must permit it.

## Activity data

| Source | Content | Licence | Notes |
| --- | --- | --- | --- |
| **ChEMBL** | Curated bioactivity, incl. kinase panels | CC BY-SA 3.0 | Primary source. Assay heterogeneity is the main issue ([C1](../01-scope/open-questions.md)) |
...
| Source | Content | Licence | Notes |
| --- | --- | --- | --- |
| **PDB** | Apo and holo structures for CDK9/7/12/13 | Public domain | Primary. Selection protocol must be written down ([C5](../01-scope/open-questions.md)) |
...
only honest held-out set for [contract 1](../02-pipeline/fidelity-contracts.md#1-co-folding-s1--replaces-experimental-structure-determination).
...
pan-CDK inhibitors as the discriminating negatives ([C3](../01-scope/open-questions.md)). The
