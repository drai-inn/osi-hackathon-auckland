...
**Primary adjacent activity:** [Activity 2](../05-delivery/adjacent-activities.md#activity-2--small-data-hyperparameter-science)
...
From [Lourie et al. 2026](../01-context/source-notes/small-scale-experiments.md) `[literature]`:
