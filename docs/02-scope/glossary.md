...
open-weight example. Our [S1](../03-pipeline/stages/S1-complex-generation.md).
...
[four](../03-pipeline/architecture.md#the-surrogate-cascade).
...
[Details](../03-pipeline/fidelity-contracts.md).
...
as a curve we extrapolate ([why not](../01-context/source-notes/small-scale-experiments.md#4-extrapolation-is-statistically-fragile)).
...
in [stage-gates.md](../06-feasibility/stage-gates.md).
